...
<body>
	...
	<section class="section-testimonials">
		...
		<div class="row">
			<div class="col span-1-of-3">
				...
				<cite><img src="resources/img/customer-1.jpg" alt="customer">Alberto Duncan</cite>
			</div>
			<div class="col span-1-of-3">
				<blockquote>
					Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
				</blockquote>
				<cite><img src="resources/img/customer-2.jpg" alt="customer">Joana Silva</cite>
			</div>
			<div class="col span-1-of-3">
				<blockquote>
					I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
				</blockquote>
				<cite><img src="resources/img/customer-3.jpg" alt="customer">Milton Chapma</cite>
			</div>						
		</div>
				...
				<form method="post" action="mailer.php" class="contact-form">
					<div class="row">
						...
						if($_GET['success'] == 1) {
							...
							echo '<div class=\"form-messages error\">Error! Something went wrong. Try again.</div>';
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbm9aGhG11Fo2xG9ilDgEm1cXzHNxqhpw"></script>
